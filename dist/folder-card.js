 ...
 */
const N="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,C=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},E=`{{lit-${String(Math.random()).slice(2)}}}`,M=`\x3c!--${E}--\x3e`,T=new RegExp(`${E}|${M}`);class A{constructor(t,e){this.parts=[],this.element=e;const n=[],i=[],s=document.createTreeWalker(e.content,133,null,!1);let r=0,o=-1,a=0;const{strings:l,values:{length:c}}=t;for(;a<c;){const t=s.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:n}=e;let i=0;for(let t=0;t<n;t++)k(e[t].name,"$lit$")&&i++;for(;i-- >0;){const e=l[a],n=V.exec(e)[2],i=n.toLowerCase()+"$lit$",s=t.getAttribute(i);t.removeAttribute(i);const r=s.split(T);this.parts.push({type:"attribute",index:o,name:n,strings:r}),a+=r.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(E)>=0){const i=t.parentNode,s=e.split(T),r=s.length-1;for(let e=0;e<r;e++){let n,r=s[e];if(""===r)n=O();else{const t=V.exec(r);null!==t&&k(t[2],"$lit$")&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),n=document.createTextNode(r)}i.insertBefore(n,t),this.parts.push({type:"node",index:++o})}""===s[r]?(i.insertBefore(O(),t),n.push(t)):t.data=s[r],a+=r}}else if(8===t.nodeType)if(t.data===E){const e=t.parentNode;null!==t.previousSibling&&o!==r||(o++,e.insertBefore(O(),t)),r=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(n.push(t),o--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(E,e+1));)this.parts.push({type:"node",index:-1}),a++}}else s.currentNode=i.pop()}for(const t of n)t.parentNode.removeChild(t)}}const k=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},D=t=>-1!==t.index,O=()=>document.createComment(""),V=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function Y(t,e){const{element:{content:n},parts:i}=t,s=document.createTreeWalker(n,133,null,!1);let r=$(i),o=i[r],a=-1,l=0;const c=[];let d=null;for(;s.nextNode();){a++;const t=s.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,r=$(i,r),o=i[r]}c.forEach(t=>t.parentNode.removeChild(t))}const U=t=>{let e=11===t.nodeType?0:1;const n=document.createTreeWalker(t,133,null,!1);for(;n.nextNode();)e++;return e},$=(t,e=-1)=>{for(let n=e+1;n<t.length;n++){const e=t[n];if(D(e))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const H=new WeakMap,R=t=>"function"==typeof t&&H.has(t),F={},j={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const L=` ${E} `;class q{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const r=V.exec(t);e+=null===r?t+(n?L:M):t.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+E}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,i){const s=e[0];if("."===s){return new K(t,e.slice(1),n).parts}return"@"===s?[new tt(t,e.slice(1),i.eventContext)]:"?"===s?[new G(t,e.slice(1),n)]:new W(t,e,n).parts}handleTextExpression(t){return new Z(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const yt=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?Object.assign(Object.assign({},e),{finisher(n){n.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(n){n.createProperty(e.key,t)}};function _t(t){return(e,n)=>void 0!==n?((t,e,n)=>{e.constructor.createProperty(n,t)})(t,e,n):yt(t,e)}
/**
@license
...
`;console.info("%c  FOLDER-CARD \n%c  Version 0.2.0    ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let Nt=class extends xt{constructor(){super(...arguments),this.isExpanded=!1}get folderEntity(){var t;if(this.config)return null===(t=this.hass)||void 0===t?void 0:t.states[this.config.entity]}get files(){var t,e,n,i;let s=null===(t=this.folderEntity)||void 0===t?void 0:t.attributes.file_list;return!1===Boolean(null===(e=this.config)||void 0===e?void 0:e.show_hidden)&&(s=s.filter(t=>-1!==this.getFileName(t).indexOf("."))),(null===(n=this.config)||void 0===n?void 0:n.sort)&&(s=s.sort((t,e)=>{var n;const i=t>e?-1:1;return"ascending"===(null===(n=this.config)||void 0===n?void 0:n.sort)?-1*i:i})),!this.isExpanded&&(null===(i=this.config)||void 0===i?void 0:i.max_count)&&(s=s.slice(0,this.config.max_count)),s}get totalFileCount(){var t,e;return null!==(e=null===(t=this.folderEntity)||void 0===t?void 0:t.attributes.file_list.length)&&void 0!==e?e:0}get canExpand(){var t,e;return Boolean(null===(t=this.config)||void 0===t?void 0:t.max_count)&&this.totalFileCount>(null===(e=this.config)||void 0===e?void 0:e.max_count)}render(){return this.config&&this.hass?this.folderEntity?this.folderEntity.attributes.file_list?0===this.files.length?this.renderEmpty():ot`
    ...
    `:this.renderWarning("The entity you passed doesn't appear to be a folder sensor."):this.renderWarning("The entity could not be found."):null}setConfig(t){if(!t)throw new Error("Invalid configuration");if(!t.entity)throw new Error("You need to set an entity");this.config=t}getCardSize(){return this.files.length}renderFile(t){return ot`
    ...
    `}renderCollapse(){const t=this.isExpanded?"Collapse":"Expand",e=this.isExpanded?"mdi:arrow-collapse-vertical":"mdi:arrow-expand-vertical";return ot`
    ...
    `:null}renderWarning(t){return ot`
      <ha-card>
        <div class="card-empty card-warning">${t}</div>
      </ha-card>
